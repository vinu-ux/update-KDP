function clearSection(stat){
    ...
    if(stat=='modal'){
        document.getElementById('mod-first').value = '' 
        document.getElementById('mod-last').value = ''
        document.getElementById('mod-phon').value  = ''
...
<div style="margin-top: 10px; padding: 5px; background-color: #f9f9f9; border-radius: 5px;">
  <h6 style="margin: 0 0 5px; color: #34495e; font-size: 18px; font-weight: 500;">${body.subject}</h6>
